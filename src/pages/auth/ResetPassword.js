...
import bgImage from '../../assets/bg_image.jpg'; // ✅ CHANGED - import background image
...
const ResetPassword = () => {
  ...
  return (
    <div 
      className="login-two-column-container"
      style={{
        backgroundImage: `url(${bgImage})`, // ✅ CHANGED - background image applied
              ...
              >
                ...
                <svg viewBox="0 0 24 24" fill="currentColor">
                  {showPassword ? (
                    ...
                    <path d="M12 7c2.76 0 5 2.24 5 5"/>
                  )}
                </svg>
              </button>
